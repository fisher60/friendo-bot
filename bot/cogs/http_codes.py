...
class HttpCodes(Cog):
    ...
    @command(brief="Get a cat http image from a http code.", aliases=["httpcat", "statuscat", "status_cat"])
    ...
    @command(brief="Get a dog http image from a http code.", aliases=["httpdog", "statusdog", "status_dog"])
    ...
    @command(brief="Get a dog or cat http image from a http code.", aliases=["status"])
